...
"""Использование %"""
print("количество участников первой команды: %d !" % team1_num)
print("В команде Мастера кода участников: %d !" % team1_num)

print("количество участников в обеих командах: %d и %d !" % (team1_num, team2_num))
...
output_result = f"Результат битвы: {challenge_result}"
output_summary = f"Сегодня было решено {tasks_total} задач, в среднем по {time_avg} секунд на задачу!"
